...
import { Heading, Table, Select, Button } from "@daxon/react-components"
import { Column, Props as TableProps } from "@daxon/react-components/dist/components/Table"
  ...
  columns.push(
    {
      header: (
        ...
        >
          <Tooltip>
            Optional. By default, PostgresDB will infer schema from the
            CSV file structure
          </Tooltip>
        </PopperHover>
      ),
