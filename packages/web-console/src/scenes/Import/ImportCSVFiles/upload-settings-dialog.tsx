...
import { Button, Select, Switch, Input } from "@daxon/react-components"
...
export const UploadSettingsDialog = ({
  ...
  const options: Option[] = [
    ...
    },
    {
      ...
      description: (
        <>
          When set to <strong>false</strong>, PostgresDB will try to infer if the
          first line of the file is the header line.
          <br />
          When set to <strong>true</strong>, PostgresDB will expect that line to be
          the header line.
        </>
      ),
