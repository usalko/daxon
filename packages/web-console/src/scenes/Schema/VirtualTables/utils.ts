...
export const createColumnNodes = (table: PostgresDB.Table, parentId: string, columns: PostgresDB.Column[]): TreeNode[] => {
...
export const createTableNode = (
  ...
  materializedViews: PostgresDB.MaterializedView[] | undefined,
  walTables: PostgresDB.WalTable[] | undefined
): TreeNode => {
