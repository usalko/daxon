...
import { Box, Button, Text } from "@daxon/react-components"
import { Refresh } from "@styled-icons/remix-line"
import {setValue} from "../../utils/localStorage"
import {StoreKey} from "../../utils/localStorage/types"
import { Preferences } from '../../utils'
import PostgresDBLogo from "./PostgresDBLogo"
...
export const SettingsProvider = ({
  ...
  const setPreferences = (preferences: Preferences) => {
    if (preferences?.instance_name) {
      const suffix = preferences?.instance_type ? `${preferences.instance_type.charAt(0).toUpperCase()}${preferences.instance_type.slice(1)}` : 'PostgresDB'
